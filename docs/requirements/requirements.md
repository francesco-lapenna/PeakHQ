...
- **F1.2.4** For each exercise within a training day the user shall define:
  - Planned sets and reps _(required)_
  - Weight / load _(optional)_
  - RPE (Rate of Perceived Exertion, 1–10) _(optional)_
  - Rest time _(optional)_
  - Tempo _(optional)_
  - Technique tags _(optional, see F1.1.4)_
  - Free-text notes _(optional)_
